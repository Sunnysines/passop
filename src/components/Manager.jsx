        ...
        <>
            ...
            <div className="mycontainer">
                ...
                <div className="fill-white flex flex-col p-4 text-black gap-8 items-center">
                    <input placeholder='Enter Website Url' type="text" className="rounded-full bg-white px-4 py-1 border border-blue-500 w-full" name="" id="" />
                    <div className="flex w-full justify-between gap-8">
                        <input placeholder='Enter Username' type="text" className="rounded-full bg-white px-4 py-1 border border-blue-500 w-full" name="" id="" />
                        <div className='relative'>

                        <input placeholder='Enter Password' type="text" className="rounded-full bg-white px-4 py-1 border border-blue-500 w-full" name="" id="" />
                        ...
                        <button className='flex justify-center items-center gap-2 bg-blue-400 rounded-full hover:bg-blue-300 px-8 py-2 w-fit border border-green-900'>
                        <lord-icon
